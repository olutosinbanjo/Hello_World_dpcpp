...
int main()
{
        try
        {
                ...
                int *a = sycl::malloc_shared<int>(N , queue_device);
                int *b = sycl::malloc_shared<int>(N , queue_device);
                int *c = sycl::malloc_shared<int>(N , queue_device);
                ...
                //array c is accessible on the host as well
